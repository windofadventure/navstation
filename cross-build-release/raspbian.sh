#!/bin/bash -xe
{
  ...
  thisArch="raspios"
  cpuArch="arm64"
  zipName="raspios_lite_arm64/images/raspios_lite_arm64-2022-09-26/2022-09-22-raspios-bullseye-arm64-lite.img.xz"
  if [ "armhf" == "$MY_CPU_ARCH" ]; then
    cpuArch="armhf"
    zipName="raspios_lite_armhf/images/raspios_lite_armhf-2022-09-26/2022-09-22-raspios-bullseye-armhf-lite.img.xz"
  fi
