...
echo 'deb [signed-by=/etc/apt/trusted.gpg.d/influxdata-archive_compat.gpg] https://repos.influxdata.com/debian bullseye main' | tee /etc/apt/sources.list.d/influxdata.list
